...
ALTER TABLE demo2
SET (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.demohistorobsy, DATA_CONSISTENCY_CHECK = ON)) 
...
ALTER TABLE contacts
SET (SYSTEM_VERSIONING = ON (HISTORY_RETENTION_PERIOD = 9 MONTHS)); seit 2017